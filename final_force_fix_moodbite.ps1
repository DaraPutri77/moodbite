...
.navbar { background: #7c2d12; color: white; padding: 18px 8%; display: flex; justify-content: space-between; align-items: center; }
...
h2 { margin: 0 0 8px; } p { line-height: 1.6; }
...
.section-header { display: flex; justify-content: space-between; align-items: center; margin: 28px 0 18px; }
...
Write-Host "SELESAI: final_force_fix_moodbite.ps1 berhasil menulis ulang file inti MoodBite." -ForegroundColor Cyan
Write-Host "LANJUTKAN: jalankan php -l, git add, git commit, git push --force." -ForegroundColor Yellow
